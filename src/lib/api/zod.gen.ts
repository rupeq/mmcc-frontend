...
export const zAggregatedMetrics = z.object({
  ...
  throughput: z.number(),
  rejection_probability_ci: z.optional(
    z.union([zConfidenceInterval, z.null()]),
  ),
  avg_channel_utilization_ci: z.optional(
    z.union([zConfidenceInterval, z.null()]),
  ),
  throughput_ci: z.optional(z.union([zConfidenceInterval, z.null()])),
});
 ...
 */
export const zTaskType = z.enum(["simulation", "animation", "optimization"]);
...
export const zTruncatedNormalParams = z.object({
  distribution: z.literal("truncated_normal"),
  mu: z.number(),
  sigma: z.number().gt(0),
  a: z.optional(z.number()).default(0),
  b: z.optional(z.union([z.number(), z.null()])),
});
...
export const zWeibullParams = z.object({
  distribution: z.literal("weibull"),
  k: z.number().gt(0),
...
export const zEmpiricalParams = z.object({
  distribution: z.literal("empirical"),
  data: z.array(z.number()).min(2).max(100000),
  method: z.optional(z.enum(["kde", "inverse_transform"])),
  bandwidth: z.optional(z.union([z.number().gt(0), z.null()])),
});
...
export const zSimulationRequestInput = z.object({
  ...
  arrivalSchedule: z.optional(
    z.union([z.array(zArrivalScheduleItem), z.null()]),
  ),
  randomSeed: z.optional(z.union([z.int(), z.null()])),
  collectGanttData: z.optional(z.boolean()).default(true),
  collectServiceTimes: z.optional(z.boolean()).default(true),
  maxGanttItems: z.optional(z.union([z.int().gte(0), z.null()])),
  maxServiceTimeSamples: z.optional(z.union([z.int().gte(0), z.null()])),
...
export const zPeakPeriod = z.object({
  period_type: z.enum(["peak", "valley"]),
  start_time: z.number(),
  end_time: z.number(),
  duration: z.number(),
  avg_busy_channels: z.number(),
...
export const zTemporalProfile = z.object({
  ...
  phase_metrics: z.optional(z.union([z.array(zPhaseMetrics), z.null()])),
...
export const zSimulationResult = z.object({
  ...
  raw_service_times: z.optional(z.union([z.array(z.number()), z.null()])),
  temporal_profile: z.optional(z.union([zTemporalProfile, z.null()])),
});
...
export const zSweepResultItem = z.object({
  parameter_value: z.union([z.int(), z.number(), z.string()]),
  report_id: z.uuid(),
  status: zReportStatus,
  metrics: z.optional(z.union([zSimulationMetrics, z.null()])),
});
...
export const zGetSimulationConfigurationReportResponse = z.object({
  id: z.uuid(),
  status: zReportStatus,
  results: z.union([zSimulationResponse, zSweepResponse, z.null()]),
  ...
  sweep_parameter_name: z.optional(z.union([z.string(), z.null()])),
  sweep_parameter_value: z.optional(
...
export const zTaskProgress = z.object({
  current: z.union([z.int(), z.number()]),
  total: z.union([z.int(), z.number()]),
...
export const zTaskError = z.object({
  code: z.string(),
  message: z.string(),
  details: z.optional(z.union([z.record(z.string(), z.unknown()), z.null()])),
  traceback: z.optional(z.union([z.string(), z.null()])),
});
...
export const zGetTaskResponse = z.object({
  ...
  progress: z.optional(z.union([zTaskProgress, z.null()])),
  result: z.optional(z.union([zTaskResult, z.null()])),
  error: z.optional(z.union([zTaskError, z.null()])),
  started_at: z.optional(z.union([z.iso.datetime(), z.null()])),
  completed_at: z.optional(z.union([z.iso.datetime(), z.null()])),
});
...
export const zGoodnessOfFitResponse = z.object({
  ...
  ks_pvalue: z.number(),
  chi2_statistic: z.optional(z.union([z.number(), z.null()])),
  chi2_pvalue: z.optional(z.union([z.number(), z.null()])),
...
export const zOptimizationRequest = z.object({
  ...
  targetRejectionProb: z.optional(
    z.union([z.number().gte(0).lte(1), z.null()]),
  ),
  maxChannels: z.optional(z.union([z.int().gte(1).lte(1000), z.null()])),
  tolerance: z.optional(z.union([z.number().gte(0).lte(1), z.null()])),
  channelCost: z.optional(z.union([z.number().gte(0), z.null()])),
  rejectionPenalty: z.optional(z.union([z.number().gte(0), z.null()])),
  rejectionWeight: z.optional(z.union([z.number().gte(0).lte(1), z.null()])),
  utilizationWeight: z.optional(z.union([z.number().gte(0).lte(1), z.null()])),
  costWeight: z.optional(z.union([z.number().gte(0).lte(1), z.null()])),
});
...
export const zOptimizationResultResponse = z.object({
  ...
  throughput: z.number(),
  total_cost: z.optional(z.union([z.number(), z.null()])),
  iterations: z.int(),
  convergence_history: z.optional(
...
export const zServiceTimeAnalysisResponse = z.object({
  ...
  theoretical_mean: z.optional(z.union([z.number(), z.null()])),
  goodness_of_fit: z.optional(z.union([zGoodnessOfFitResponse, z.null()])),
...
export const zServiceTimeVisualizationsResponse = z.object({
  ...
  ecdf: zPlotResponse,
  qq_plot: z.optional(z.union([zPlotResponse, z.null()])),
});
...
export const zSweepParameter = z.object({
  name: z.string(),
  values: z.array(z.union([z.int(), z.number()])).min(1),
});
 ...
 * Successful Response
 */
export const zSignupApiV1AuthorizationSignupPostResponse =
...
export const zGetSimulationsApiV1SimulationsGetData = z.object({
  ...
  query: z.optional(
    z.object({
      columns: z.optional(z.union([z.array(z.string()), z.null()])),
      filters: z.optional(z.union([z.string(), z.null()])),
      page: z.optional(z.union([z.int().gte(1), z.null()])),
      limit: z.optional(z.union([z.int().gte(1).lte(100), z.null()])),
    }),
  ),
});
 ...
 * Successful Response
 */
export const zGetSimulationsApiV1SimulationsGetResponse =
  zGetSimulationsResponse;
 ...
 * Successful Response
 */
export const zCreateSimulationApiV1SimulationsPostResponse =
  zCreateSimulationResponse;

export const zDeleteSimulationConfigurationApiV1SimulationsSimulationConfigurationIdDeleteData =
  z.object({
    body: z.optional(z.never()),
    path: z.object({
      simulation_configuration_id: z.uuid(),
 ...
 * Successful Response
 */
export const zDeleteSimulationConfigurationApiV1SimulationsSimulationConfigurationIdDeleteResponse =
  z.void();

export const zGetSimulationConfigurationApiV1SimulationsSimulationConfigurationIdGetData =
  z.object({
    body: z.optional(z.never()),
    path: z.object({
      simulation_configuration_id: z.uuid(),
 ...
 * Successful Response
 */
export const zGetSimulationConfigurationApiV1SimulationsSimulationConfigurationIdGetResponse =
  zGetSimulationConfigurationResponse;

export const zDeleteSimulationConfigurationReportApiV1SimulationsSimulationConfigurationIdReportsReportIdDeleteData =
  z.object({
    body: z.optional(z.never()),
    path: z.object({
      simulation_configuration_id: z.uuid(),
 ...
 * Successful Response
 */
export const zDeleteSimulationConfigurationReportApiV1SimulationsSimulationConfigurationIdReportsReportIdDeleteResponse =
  z.void();

export const zGetSimulationConfigurationReportApiV1SimulationsSimulationConfigurationIdReportsReportIdGetData =
  z.object({
    body: z.optional(z.never()),
    path: z.object({
      simulation_configuration_id: z.uuid(),
 ...
 * Successful Response
 */
export const zGetSimulationConfigurationReportApiV1SimulationsSimulationConfigurationIdReportsReportIdGetResponse =
  zGetSimulationConfigurationReportResponse;

export const zGetSimulationConfigurationReportsApiV1SimulationsSimulationConfigurationIdReportsGetData =
  z.object({
    body: z.optional(z.never()),
    path: z.object({
      simulation_configuration_id: z.uuid(),
 ...
 * Successful Response
 */
export const zGetSimulationConfigurationReportsApiV1SimulationsSimulationConfigurationIdReportsGetResponse =
  zGetSimulationConfigurationReportsResponse;
...
export const zRunSimulationApiV1SimulationsSimulationConfigurationIdRunPostData =
  z.object({
    body: z.optional(z.never()),
    path: z.object({
      simulation_configuration_id: z.uuid(),
 ...
 * Successful Response
 */
export const zRunSimulationApiV1SimulationsSimulationConfigurationIdRunPostResponse =
  zRunSimulationResponse;
 ...
 * Successful Response
 */
export const zRunParameterSweepApiV1SimulationsSweepPostResponse =
  zSweepResponse;
 ...
 * Successful Response
 */
export const zGetSweepStatusApiV1SimulationsSweepBatchIdGetResponse =
  zSweepResponse;
...
export const zGetBackgroundTasksApiV1BackgroundTasksGetData = z.object({
  ...
  query: z.optional(
    z.object({
      subject_ids: z.optional(z.union([z.array(z.string()), z.null()])),
    }),
  ),
});
 ...
 * Successful Response
 */
export const zGetBackgroundTasksApiV1BackgroundTasksGetResponse =
  zGetBackgroundTasksResponse;

export const zGetBackgroundTaskApiV1BackgroundTasksBackgroundTaskIdGetData =
  z.object({
    body: z.optional(z.never()),
    path: z.object({
 ...
 * Successful Response
 */
export const zGetBackgroundTaskApiV1BackgroundTasksBackgroundTaskIdGetResponse =
  zGetBackgroundTaskResponse;

export const zGetTaskApiV1BackgroundTasksBackgroundTaskIdTasksTaskIdGetData =
  z.object({
    body: z.optional(z.never()),
    path: z.object({
      background_task_id: z.uuid(),
 ...
 * Successful Response
 */
export const zGetTaskApiV1BackgroundTasksBackgroundTaskIdTasksTaskIdGetResponse =
  zGetTaskResponse;

export const zGetServiceTimeAnalysisApiV1SimulationsSimulationConfigurationIdReportsReportIdServiceTimeAnalysisGetData =
  z.object({
    body: z.optional(z.never()),
    path: z.object({
      simulation_configuration_id: z.uuid(),
    ...
    query: z.optional(
      z.object({
        significance_level: z
          .optional(z.number().gte(0.01).lte(0.1))
          .default(0.05),
      }),
    ),
  });
 ...
 * Successful Response
 */
export const zGetServiceTimeAnalysisApiV1SimulationsSimulationConfigurationIdReportsReportIdServiceTimeAnalysisGetResponse =
  zServiceTimeAnalysisResponse;

export const zGetServiceTimeVisualizationsApiV1SimulationsSimulationConfigurationIdReportsReportIdServiceTimeVisualizationsGetData =
  z.object({
    body: z.optional(z.never()),
    path: z.object({
      simulation_configuration_id: z.uuid(),
 ...
 * Successful Response
 */
export const zGetServiceTimeVisualizationsApiV1SimulationsSimulationConfigurationIdReportsReportIdServiceTimeVisualizationsGetResponse =
  zServiceTimeVisualizationsResponse;

export const zGetServiceTimeHistogramImageApiV1SimulationsSimulationConfigurationIdReportsReportIdServiceTimeHistogramGetData =
  z.object({
    body: z.optional(z.never()),
    path: z.object({
      simulation_configuration_id: z.uuid(),
...
export const zGetServiceTimeEcdfImageApiV1SimulationsSimulationConfigurationIdReportsReportIdServiceTimeEcdfGetData =
  z.object({
    body: z.optional(z.never()),
    path: z.object({
      simulation_configuration_id: z.uuid(),
...
export const zGetServiceTimeQqPlotImageApiV1SimulationsSimulationConfigurationIdReportsReportIdServiceTimeQqPlotGetData =
  z.object({
    body: z.optional(z.never()),
    path: z.object({
      simulation_configuration_id: z.uuid(),
...
export const zGetGanttChartApiV1SimulationsSimulationConfigurationIdReportsReportIdGanttGetData =
  z.object({
    body: z.optional(z.never()),
    path: z.object({
      simulation_configuration_id: z.uuid(),
...
export const zRequestAnimationGenerationApiV1SimulationsSimulationConfigurationIdReportsReportIdAnimationPostData =
  z.object({
    body: z.optional(z.never()),
    path: z.object({
      simulation_configuration_id: z.uuid(),
 ...
 * Successful Response
 */
export const zRequestAnimationGenerationApiV1SimulationsSimulationConfigurationIdReportsReportIdAnimationPostResponse =
  zCreateAnimationResponse;

export const zGetAnimationApiV1SimulationsSimulationConfigurationIdReportsReportIdAnimationsBackgroundTaskIdGetData =
  z.object({
    body: z.optional(z.never()),
    path: z.object({
      simulation_configuration_id: z.uuid(),
 ...
 * Successful Response
 */
export const zGetAnimationApiV1SimulationsSimulationConfigurationIdReportsReportIdAnimationsBackgroundTaskIdGetResponse =
  z.string();

export const zGetTemporalAnalysisApiV1SimulationsSimulationConfigurationIdReportsReportIdTemporalAnalysisGetData =
  z.object({
    body: z.optional(z.never()),
    path: z.object({
      simulation_configuration_id: z.uuid(),
 ...
 * Successful Response
 */
export const zGetTemporalAnalysisApiV1SimulationsSimulationConfigurationIdReportsReportIdTemporalAnalysisGetResponse =
  zGetTemporalAnalysis;

export const zGetTemporalChartsApiV1SimulationsSimulationConfigurationIdReportsReportIdTemporalChartsGetData =
  z.object({
    body: z.optional(z.never()),
    path: z.object({
      simulation_configuration_id: z.uuid(),
 ...
 * Successful Response
 */
export const zGetTemporalChartsApiV1SimulationsSimulationConfigurationIdReportsReportIdTemporalChartsGetResponse =
 ...
 * Successful Response
 */
export const zOptimizeChannelsApiV1SimulationsOptimizePostResponse =
  zOptimizationResultResponse;
